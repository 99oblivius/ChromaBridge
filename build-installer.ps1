#!/usr/bin/env pwsh
# PowerShell build script for Color Interlacer installer

Write-Host "Building Color Interlacer..." -ForegroundColor Cyan

# Build release binaries
Write-Host "`nBuilding release binaries..." -ForegroundColor Yellow
cargo build --release
...
Write-Host ""
Write-Host "Installer created successfully at: target\ColorInterlacer-Setup.exe" -ForegroundColor Green